...
class LatestQuizListPage extends StatefulWidget {
  @override
  State<LatestQuizListPage> createState() => _LatestQuizListPageState();
}

class _LatestQuizListPageState extends State<LatestQuizListPage> {
  int _selectedIndex = 0;
  bool isCouponApplied = false; 
  String appliedCouponCode = ""; 
  final latestquizListController = Get.put<LatestquizlistController>(LatestquizlistController());
  ...
  void _onItemTapped(int index) {
   ...
   Future<void> _refreshQuizzes() async {
    ...
    await  latestquizListController.latestquizgetQuiz(); 
  }
  @override
  void initState() {
    super.initState();
    latestquizListController.latestquizgetQuiz();
  }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 20),
                          Obx(
                            () => latestquizListController.isLoading.value
                                ? CircularProgressIndicator()
                                : latestquizListController.latestquizGetList.isEmpty
                                    ? Column(
                                        children: [
                                    ...
                                    : Column(
                                        children: List.generate(
                                          latestquizListController.latestquizGetList.length,
                                          (index) {
                                             index++;
                                            return Column(
                                              children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: Text(
                                                                       latestquizListController.latestquizGetList[index-1].isLive ?? false ? 'Live Quiz' : 'Schedule Quiz',
                                                                style: TextStyle(
                                                                  color: Colours.wronganswer,
                                                                  fontFamily: FontFamily.rubik,
                                                                  fontSize: 15,
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Text(
                                                                latestquizListController.latestquizGetList[index-1].isFree ?? false ? 'Free' : '₹${  latestquizListController.latestquizGetList[index-1].amount}',
                                                                style: TextStyle(
                                                                  color: Colours.correctanswer,
                                                                  fontFamily: FontFamily.rubik,
                                                                  fontSize: 16,
                                                        ...
                                                        SizedBox(height: 10),
                                                        Text(
                                                          '${  latestquizListController.latestquizGetList[index-1].quizTitle}',
                                                          style: TextStyle(
                                                            color: Colours.black,
                                                            fontSize: 20,
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            SizedBox(width: 5),
                                                            Text(
                                                              '${  latestquizListController.latestquizGetList[index-1].numberOfQuestions} questions',
                                                              style: TextStyle(
                                                            ...
                                                            SizedBox(width: 10),
                                                            Text(
                                                              '${  latestquizListController.latestquizGetList[index-1].quizDuration} mins',
                                                              style: TextStyle(
                                                                color: Colours.textColour,
                                                                fontFamily: FontFamily.rubik,
                                                                fontSize: 15,
                                                            ...
                                                            SizedBox(width: 10),
                                                            Text(
                                                              '${  latestquizListController.latestquizGetList[index-1].noOfMarks} marks',
                                                              style: TextStyle(
                                                                color: Colours.textColour,
                                                                fontFamily: FontFamily.rubik,
                                                                fontSize: 15,
                                                       ...
                                                       SizedBox(height: 20),
                                                        Row(
  children: [
    if ( latestquizListController.latestquizGetList[index - 1].isScheduled ?? false)
    ...
    if ( latestquizListController.latestquizGetList[index - 1].isScheduled ?? false)
      Obx(() {
        final quizSchedule =
           latestquizListController.latestquizGetList[index - 1].quizSchedule;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                               '${ latestquizListController.latestquizGetList[index-1].createdBy}',
                            style: TextStyle(
                              fontFamily: FontFamily.rubik,
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
  ...
  onPressed: () async {
    ...
    final quiz = latestquizListController.latestquizGetList[index - 1];
